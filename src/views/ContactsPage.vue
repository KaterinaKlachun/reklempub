<template>
  ...
  <div class="intelligence">
      ...
      <div class="right">
          <div class="up_right">
              <p>Пн-Пт:</p>
              <p id="time">09:30 - 18:00</p>   
          </div>
          <div class="down_right">
              <p>Сб-Вс:</p>
              <p id="time">Выходной</p>
          </div>
          <img src="@/assets/img/contacts/instargam.svg" alt="instargam">
